...
#define ROM_ROMv6_INTERPRETER  0x0048
...
namespace Cpu
{
    enum RomType {ROMERR=0x00, ROMv1=0x1c, ROMv2=0x20, ROMv3=0x28, ROMv4=0x38, ROMv5a=0x40, ROMv6=0x48, ROMvX0=0x80, SDCARD=0xF0, DEVROM=0xF8};
    enum RomTypeAddr {ROMADDRERR=0x0000, ROMADDRv1=0x009A, ROMADDRv2=0x0098, ROMADDRv3=0x0098, ROMADDRv4=0x007E, ROMADDRv5a=0x005E, ROMADDRv6=0x005F,
                      ROMADDRvX0=0x0000, SDCARDADDR=0x005E, DEVROMADDR=0x005E};
