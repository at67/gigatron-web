...
%SUB                resetVideoFlags
resetVideoFlags     ANDBI   miscFlags, MISC_ON_BOTTOM_ROW_MSK   ; reset on bottom row flag
%if FONT_BOTH
                    MOVQW   cursorXY, giga_CursorX              ; starting 6x8 cursor position
%endif
%if FONT_6X8
                    MOVQW   cursorXY, giga_CursorX              ; starting 6x8 cursor position
%endif
%if FONT_4X6
                    MOVQW   cursorXY, 0                         ; starting 4x6 cursor position
%endif
                    RET
%ENDS
