...
%if FONT_BOTH
                    ...
                    BEQ     printC6x8                           ; is fnt4x6 enabled flag?
                    CALLI   printChar4x6
                    POP
                    RET
printC6x8           CALLI   printChar6x8
%endif
%if FONT_6X8
                    CALLI   printChar6x8
%endif
...
printC_slice        LDW     textFont                            ; text font slice base address
                    ...
                    BNE     printC6x8_exit                      ; is text clipping disabled?
                    PUSH
                    CALLI   printClip
                    POP
printC6x8_exit      RET
...
printChar4x6        FNT4X6  textFont, textChr
                    ...
                    ANDBK   miscFlags, MISC_DISABLE_CLIP_BIT
                    BNE     printC4x6_exit                      ; is text clipping disabled?
                    PUSH
                    CALLI   printClip4x6
                    POP
printC4x6_exit      RET
...
%if TEXT_SCROLL
                    PUSH
                    CALLI   newLineScroll6x8                    ; next row, scroll at bottom
                    POP
%else
...
%if FONT_BOTH
                    ANDBK   miscFlags, MISC_ENABLE_FNT4X6_BIT
                    BEQ     newLS6x8                            ; is fnt4x6 enabled flag?
                    CALLI   newLineScroll4x6
                    POP
                    RET
newLS6x8            CALLI   newLineScroll6x8
%endif
%if FONT_6X8
                    CALLI   newLineScroll6x8
%endif
%if FONT_4X6
                    CALLI   newLineScroll4x6
%endif
...
newLineScroll       ANDBK   miscFlags, MISC_ENABLE_FNT4X6_BIT
                    ...
                    POP
                    RET
newLS6x8            LDI     giga_CursorX                        ; cursor x start
                    ST      cursorXY
                    ST      giga_sysArg4
%endif
%if FONT_6X8
...
%endif
%if FONT_4X6
newLineScroll       LDI     0                                   ; cursor x start
                    ST      cursorXY
                    ST      giga_sysArg4
%endif
                    RET
...
newLineScroll6x8    PUSH
                    ...
                    BNE     newLS68_cont0                       ; is scroll on or off?
                    RET

newLS68_cont0       ANDBK   miscFlags, MISC_ON_BOTTOM_ROW_BIT
                    BNE     newLS68_cont1                       ; is on bottom row flag?
